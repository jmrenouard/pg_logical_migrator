...
_pg_migrator_completion() {
    ...
    # Subcommands
    subcmds="check diagnose params migrate-schema-pre-data migrate-schema-post-data setup-pub setup-sub repl-status repl-progress sync-sequences enable-triggers disable-triggers refresh-matviews reassign-owner audit-objects validate-rows cleanup init-replication post-migration tui generate-config"
